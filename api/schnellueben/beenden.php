 ...
 * Body: { sitzung_id }
 *
 * Schliesst die Schnellueben-Sitzung ab, aktualisiert Streak, XP, Sterne,
...
$stmt = $pdo->prepare("
    ...
    VALUES (?, 'training', ?, ?)
");
$beschreibung = "Schnellueben abgeschlossen: {$anzahl_richtig}/{$anzahl_fragen} richtig, +{$xp_verdient} XP";
$details = json_encode([
...
// ============================================================
// Belohnungs-Pruefung (kopiert aus training/beenden.php)
// ============================================================
